  ...
  return (
    <div className="bg-white py-8 px-5 rounded-md shadow-custom_secondary grid lg:grid-cols-4 gap-8">
      ...
      <div className="relative">
        <select class="input_styles relative appearance-none focus:outline-none focus:border-blue-500" name="Category" id="Category">
          <option value="Category" class="text-gray-500">
            Category
          </option>
      ...
      <div className="relative">
        <select class="input_styles relative appearance-none focus:outline-none focus:border-blue-500" name="Price" id="price">
          <option value="Price" class="text-gray-500">
            Price
          </option>
      ...
      <div className="text-center">
        <button className="bg-primary-600 text-white lg:w-4/6 w-full cursor-pointer py-3 border-none rounded-md font-medium">
          {" "}
          <span>
            <svg
              xmlns="http://www.w3.org/2000/svg"
