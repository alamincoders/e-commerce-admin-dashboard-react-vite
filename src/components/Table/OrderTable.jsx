            ...
            <div
                        ...
                        <div className="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                            <table className="min-w-full divide-y divide-gray-200">
                                ...
                                <tbody className="bg-white divide-y divide-gray-200">
                                    {currentItems.map(order => <tr className="hover:bg-gray-50">
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap text-sm font-medium flex gap-4">
                                            <div class="relative inline-block">
                                                <select
                                                    class="block appearance-none w-full bg-white border border-gray-400 text-gray-400 hover:border-gray-500 px-4 py-1.5 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline">
                                                ...
                                                <div
                                                    ...
                                                    <svg
                                                        ...
                                                        viewBox="0 0 20 20"><path d="M10 12l-5-5 1.41-1.41L10 9.18l3.59-3.59L15 7l-5 5z"/></svg>
                                                </div>
                                            </div>
                ...
                <div
                    ...
                    <p className='uppercase font-semibold'>showing ({itemsOffset + 1}
                        - {itemsOffset + currentItems.length}) of {orders.length}</p>
                    <UsePagination
                        pageCount={pageCount}
